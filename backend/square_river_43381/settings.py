"""
Django settings for square_river_43381 project.
...
ROOT_URLCONF = 'square_river_43381.urls'
...
WSGI_APPLICATION = 'square_river_43381.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_river_43381 API",
    "DESCRIPTION": "API documentation for square_river_43381 App",
    "VERSION": "v1",
}
